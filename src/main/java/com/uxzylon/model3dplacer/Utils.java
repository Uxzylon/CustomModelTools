...
public class Utils {
    ...
    public static final ItemStack getCustomSkull(String url) {
        ...
        try {
            ...
            Logger.getLogger(Utils.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    public static String noSelection = ChatColor.GOLD + "Vous n'avez pas de selection ! " + ChatColor.LIGHT_PURPLE + "/model3d select";
